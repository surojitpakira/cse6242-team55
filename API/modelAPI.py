...
SHELF = {
    'approval'     :'saved_model/approval_model.sav',
    'interest_rate':'saved_model/interest_rate_model.sav',
    'alternative'  :'saved_model/alternative_model.sav',
    'creditscore'  :'saved_model/credit_score_model.sav'
}
